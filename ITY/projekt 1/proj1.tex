...
\author{Adrián Matušík \\ \href{mailto:xmatus35@stud.fit.vutbr.cz}{xmatus35@stud.fit.vutbr.cz}}
\date{}
...
Zvýraznění barvou, podtržením, ani změnou písma se \mbox{v odstavcích} nepoužívá.
...
\begin{quotation}
Čím více \textit{druhů}, \textbf{řezů}, {\huge velikostí}, {\color{blue} barev} písma a jiných {\color{red} \scshape efektů} \underline{použijeme}, tím {\color{orange} profesio\-nálněji} bude {\Large \fontfamily{pzc}\selectfont dokument} vypadat.
...
Druhou odlišností je pravidlo pro sázení konců řádků. V české sazbě do bloku by řádek neměl končit osamocenou jednopísmennou předložkou nebo spojkou. Spojkou \uv{a} končit může pouze při sazbě do šířky 25 liter. Abychom \LaTeX u zabránili v sázení osamocených předložek, spojujeme je s následujícím slovem \emph{nezlomitelnou mezerou}. Tu sázíme pomocí znaku \verb|~| (vlnka, tilda). Pro systematické doplnění vlnek slouží volně šiřitelný program \emph{vlna} od pana Olšáka\footnote{Viz \href{http://petr.olsak.net/ftp/olsak/vlna/}{{\fontfamily{cmtt}\selectfont http://petr.olsak.net/ftp/olsak/vlna/}}}, který si můžete v rámci projektu vyzkoušet.

Balíček \verb|fontenc| slouží ke korektnímu kódovaní znaků \mbox{s diakritikou}, aby bylo možno v textu vyhledávat a kopí\-rovat z něj.

\section{Závěr}
Tento dokument schválně obsahuje několik typografických prohřešků. Sekce \hyperlink{section.2}{2} a \hyperlink{section.3}{3} obsahují typografické chyby. V kontextu celého textu je jistě snadno najdete. Je dobré znát možnosti \LaTeX u, ale je také nutné vědět, kdy je nepoužít.
